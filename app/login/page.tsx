        ...
        <div className="panel rounded p-8 shadow-black/40">
          ...
          {checkEmail ? (
            ...
            <form action={sendMagicLink} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 rounded-btn bg-accent-fill px-6 py-3.5 text-sm font-semibold text-on-accent shadow-lift motion-safe:transition-colors hover:bg-accent-fill-hover"
              >
